let classmethod = [{
    "code": "Camera",
    "text": "相机工具",
    "children": [{"code": "SetIsUseRightBtn", "text": "右键旋转", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "Move",
        "text": "相机移动",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "SetMoveTarget", "text": "设置相机围绕目标位置设置", "obj": 2, "par": 2, "dotw": 2}, {
        ...
        "par": 2,
        "dotw": 2
    }, {"code": "CameraMaximizeShowObject", "text": "移动相机最大化显示物体", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "Open",
        "text": "开启相机",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "Close", "text": "关闭相机", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "Depth",
        "text": "设置相机深度",
        "obj": 2,
        "par": 2,
    ...
    "children": [{"code": "Position", "text": "UI位移移动", "obj": 2, "par": 2, "dotw": 2}, {
        ...
        "par": 2,
        "dotw": 2
    }, {"code": "Operate", "text": "UI状态可操作", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "Notoperate",
        "text": "UI状态不可操作",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "RayDetection", "text": "射线操作", "obj": 2, "par": 2, "dotw": 2}, {
        ...
        "par": 2,
        "dotw": 2
    }, {"code": "SetImagerSprite", "text": "UI替换图片", "obj": 2, "par": 2, "dotw": 2}]
}, {
    "code": "Audio",
    "text": "音频工具",
    ...
    "code": "Speak",
    "text": "语音工具",
    "children": [{"code": "Open", "text": "打开文字语音播放", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "Close",
        "text": "关闭文字语音播放",
        "obj": 2,
        "par": 2,
        ...
        "par": 2,
        "dotw": 2
    }, {"code": "Pitch", "text": "设置文字语音音高", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "Volume",
        "text": "设置文字语音大小",
        "obj": 2,
        "par": 2,
    ...
    "code": "Effect",
    "text": "特效工具",
    "children": [{"code": "Close", "text": "关闭特效", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "Open",
        "text": "开启特效",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "Speed", "text": "设置特效速度", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "Play",
        "text": "播放特效",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "Pause", "text": "暂停特效", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "Stop",
        "text": "停止特效",
        "obj": 2,
        "par": 2,
        ...
        "par": 2,
        "dotw": 2
    }, {"code": "CreatFlowLine", "text": "创建流线粒子", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "DestoryFlowLine",
        "text": "销毁流线粒子",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "CreatFire", "text": "加载粒子特效预制体", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "Closemulti",
        "text": "关闭特效",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "Openmulti", "text": "开启特效", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "Playmulti",
        "text": "播放特效",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "Pausemulti", "text": "暂停特效", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "Stopmulti",
        "text": "停止特效",
        "obj": 2,
        "par": 2,
    ...
    "children": [{
        ...
        "par": 2,
        "dotw": 2
    }, {"code": "CloseAllMaterialFlash", "text": "关闭所有闪烁", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "SetAllShader",
        "text": "开启未选择物体透明",
        "obj": 2,
        "par": 2,
        ...
        "par": 2,
        "dotw": 2
    }, {"code": "SetSkyBox", "text": "设置天空盒", "obj": 2, "par": 2, "dotw": 2}]
}, {
    "code": "Object",
    "text": "物体类工具",
    "children": [{"code": "PlayVideo", "text": "物体播放视频", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "VideoStart",
        "text": "视频流状态",
        "obj": 2,
        "par": 2,
        ...
        "par": 2,
        "dotw": 2
    }, {"code": "Hide", "text": "隐藏物体--隐藏MeshRender", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "ShowObj",
        "text": "显示物体--显示Obj",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "HideObj", "text": "隐藏物体--隐藏Obj", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "ChildHide",
        "text": "隐藏物体及其子物体",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "ChildShow", "text": "显示物体及其子物体", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "PlayAniamtion",
        "text": "播放动画",
        "obj": 2,
        "par": 2,
        ...
        "par": 2,
        "dotw": 2
    }, {"code": "PassSortConfigAniamtion", "text": "按动画阶段暂停配置动画", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "SetPatent",
        "text": "设置物体父物体",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "OpenTranslucence", "text": "打开物体半透明", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "CloseTranslucence",
        "text": "关闭物体透明",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "OpenFlash", "text": "开启物体闪烁", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "CloseFlash",
        "text": "关闭物体闪烁",
        "obj": 2,
        "par": 2,
        ...
        "par": 2,
        "dotw": 2
    }, {"code": "AnimationStatePlay", "text": "动画状态播放", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "AnimationStateStop",
        "text": "动画状态停止",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "AddColliderBox", "text": "添加ColliderBox", "obj": 2, "par": 2, "dotw": 2}, {
        ...
        "par": 2,
        "dotw": 2
    }, {"code": "CloseColldierMesh", "text": "关闭MeshCollider", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "AddScene",
        "text": "设置添加场景",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "UnLoadAddScene", "text": "卸载添加场景", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "SetLightColor",
        "text": "设置灯光颜色",
        "obj": 2,
        "par": 2,
    ...
    "children": [{"code": "3DTextColor", "text": "3D状态文字颜色", "obj": 2, "par": 2, "dotw": 2}, {
        ...
        "par": 2,
        "dotw": 2
    }, {"code": "3DTextContent", "text": "3D状态文字内容", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "3DPositon",
        "text": "3D状态文字位移",
        "obj": 2,
        "par": 2,
    ...
    "code": "MeasureSend",
    "text": "测发工具",
    "children": [{"code": "SendDotNetMsg", "text": "测发播放结束", "obj": 2, "par": 2, "dotw": 2}]
}, {
    "code": "StructureEvent",
    "text": "结构展示工具",
    "children": [{"code": "DefaultView", "text": "设置默认视图", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "LeftView",
        "text": "左视图",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "FrontView", "text": "前视图", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "TopView",
        "text": "顶视图",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "ResetMode", "text": "重置模型", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "ResetMateria",
        "text": "重置模型材质",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "ResetShader", "text": "开启未选择物体透明", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "InitCameraAttribute",
        "text": "初始化相机尺寸",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "CameraDistance", "text": "相机距离", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "ShowModelSize",
        "text": "显示模型尺寸",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "HdieModelSize", "text": "隐藏模型尺寸", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "IcoButUI",
        "text": "wer快捷键",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "Show", "text": "物体Mesh显示控制", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "Hide",
        "text": "物体Mesh隐藏控制",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "ChildShow", "text": "显示模型", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "ChildHide",
        "text": "隐藏模型",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "ShowSelectChild", "text": "孤立显示选择模型", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "ResetSlider",
        "text": "重置滑块",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "ShowInfo", "text": "显示UI信息", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "HideInfo",
        "text": "隐藏UI信息",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "HideOrShowModelInfo", "text": "是否显示模型信息", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "AutoExplosive",
        "text": "自主拆装爆炸图",
        "obj": 2,
        "par": 2,
        "dotw": 2
    }, {"code": "SetIconButtonStart", "text": "设置图片按钮状态", "obj": 2, "par": 2, "dotw": 2}]
}, {
    "code": "Assembled",
    "text": "拆装事件工具",
    "children": [{
    ...
    "children": [{"code": "Time", "text": "时间", "obj": 2, "par": 2, "dotw": 2}, {
        ...
        "par": 2,
        "dotw": 2
    }, {"code": "Seasons", "text": "四季--时间插件中的四季", "obj": 2, "par": 2, "dotw": 2}, {
        "code": "SetWatherNew",
        "text": "新的天气--粒子天气插件的天气",
        "obj": 2,
        "par": 2,
        ...
        "par": 2,
        "dotw": 2
    }, {"code": "UpdateMiniStepInfo", "text": "拆装消息更新小步标题", "obj": 2, "par": 2, "dotw": 2}, {
